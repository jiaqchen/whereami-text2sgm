...
class Timer:
    ...
    def save(self, path, args):
        with open(path, 'w') as f:
            ...
            time_for_embedding = sum(self.text2graph_text_embedding_matching_score_time) / sum(self.text2graph_text_embedding_matching_score_iter)
            ...
            f.write(f'Std of embedding time: {np.std(self.text2graph_text_embedding_matching_score_time)}\n')
            ...
            calc_time = time_for_embedding * args.out_of + time_for_matching
            # save total run time
